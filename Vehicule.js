/*
  ...
  */
  ...
  class Vehicle {
    ...
    // seek et avoid
    applyBehaviors(target, obstacles,Véhicules ) {
      
    
        
     // let seekForce = this.arrive(target);
      
      let avoidForce = this.avoidAmeliore(obstacles,Véhicules );
    ...
    */
    avoidAmeliore(obstacles,Véhicules ) {
      // calcul d'un vecteur ahead devant le véhicule
      // il regarde par exemple 50 frames devant lui
      let ahead = this.vel.copy();
      ahead.normalize();
      ...
      // Detection de l'obstacle le plus proche
      let obstacleLePlusProche = this.getObstacleLePlusProche(obstacles,Véhicules );
    ...
    getObstacleLePlusProche(obstacles,Véhicules ) {
    ...
    getClosestObstacle(pos, obstacles,Véhicules ) {
